...
'>> q = p '
'>> p = q . p '
# Try to understand the code and use your time to learn
def SpyshareGroup
...
$Check_lib = system('gem list -i colorize', :err => File::NULL);system('clear')
if $Check_lib == true
SpyshareGroup()
else;system('gem install colorize');system('clear');SpyshareGroup()
end